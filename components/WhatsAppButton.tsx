...
type WhatsAppButtonProps = {
  ...
  phone?: string;
  /** Rótulo acessível; default genérico. */
  label?: string;
  className?: string;
};

const DEFAULT_MESSAGE =
  "Olá! Gostaria de mais informações sobre os empreendimentos do Grupo Natus.";

/**
 * Botão flutuante de WhatsApp (FR6) — única abstração de UI de WhatsApp.
 * Consome lib/whatsapp; nunca monta URL/numero inline (AD-3).
 */
